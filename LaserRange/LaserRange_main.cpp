...
/********************************************************************************************\
作者信息：
姓名：大虎		Email：1657404542@qq.com
项目简介;
本项目是《激光束3维重建》的代码部分，本代码使用opencv3.0版本，C++编写，主要进行的操作有：
获取摄像头图像数据，软件二值化，计算坐标点，写入相关文件。
项目历史：
本项目于2017年5月决定主题，并在后来的一年时间了走走停停
本项目于2018年4月20号完全完成，效果一般，还有很多改进的余地
本项目于2018年4月21号上传至github上，希望日后有时间和能力可以进行修正和改进
其它说明：
本项目只是借鉴了前人的经验，主要是想自己学习OPENCV和作为计算机视觉的入门，纯属试探作品，
其实代码不多，集中精力一周就能学会，并搞定这个东西，只是自己平时慵懒，荒于学习，非要等到
项目结束验收时才加班加点，通宵调试。后来发现这个作品还有很大的提升空间。可是验收已经通过
，又有其它事情要做，于是将其上传到网上，希望在某天心血来潮可以将这个项目优化，能化解此时愧
疚之感。只怕长路漫漫，再无回返之时。愿以后的路上能不重蹈覆辙，再见了。
***********************************************************************************************/
#include<opencv.hpp>
#include<windows.h>
#include<iostream>
